...
export default function TableCheque({
  ...
  console.log('TableCheque mode : ', mode);
  ...
  const handleAdd = (): void => {
    ...
    const newCheque: TableChequeType = { ...INIT_DATA_CHEQUE[0], id: uuidv4(), mode: newMode, bankCode: bankCode };
