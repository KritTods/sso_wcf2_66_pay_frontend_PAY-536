...
export const URL: DataStructureURL = {
  ...
  taxDeliver: {
    ...
    taxDeliverReadyToPayDetail: {
      url: '/tax-deliver/readytopay/detail',
      text: 'รายละเอียด',
      breadcrumb: ['root', 'taxDeliverReadyToPay', 'taxDeliverReadyToPayDetail'],
      pageLevel: { form: [2] },
    },
    taxDeliverReadyToPayOffice: {
      url: '/tax-deliver/readytopay/payment-office',
      text: 'เตรียมนำส่งภาษีหัก​ ณ ที่จ่าย - รับเงิน ณ สำนักงาน',
    ...
    taxDeliverReadyToPayOfficeDetail: {
      ...
      text: 'รายละเอียดข้อมูลเตรียมจ่าย',
      breadcrumb: [
        'root',
        'taxDeliverReadyToPay',
        'taxDeliverReadyToPayOffice',
    ...
    taxDeliverReadyToPayBank: {
      ...
      text: 'เตรียมนำส่งภาษีหัก​ ณ ที่จ่าย - โอนผ่านธนาคารจังหวัด',
    ...
    taxDeliverReadyToPayCheque: {
      ...
      text: 'เตรียมนำส่งภาษีหัก​ ณ ที่จ่าย - ส่งเช็คทางไปรษณีย์',
  ...
  receiptManual: {
    ...
    receiptManualDoctorSalary: {
      url: '/receipt-manual/doctor-salary',
      text: 'จ่ายเงินทดแทน/ค่าตอบแทนแพทย์',
